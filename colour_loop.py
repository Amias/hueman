#!/usr/bin/python
#
# This is a script that colourloopw all the hues
#
...
argparser = argparse.ArgumentParser(description='Colorloop your hue lights')
...
print "Set all Hue Lights to Colorloop by Amias Channer"
